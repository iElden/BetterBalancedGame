...
UPDATE Buildings SET Cost=Cost/2 WHERE BuildingType='BUILDING_ELECTRONICS_FACTORY';
UPDATE Buildings SET Cost=Cost/2 WHERE BuildingType='BUILDING_MADRASA';
...
-- additional builder charge moved from quin shi huang to china ability to buff china kublai
DELETE FROM TraitModifiers WHERE TraitType = 'FIRST_EMPEROR_TRAIT' AND ModifierId = 'TRAIT_ADJUST_BUILDER_CHARGES';
INSERT OR IGNORE INTO TraitModifiers (TraitType, ModifierId)
VALUES ('TRAIT_CIVILIZATION_DYNASTIC_CYCLE', 'TRAIT_ADJUST_BUILDER_CHARGES');
...
-- Reduce garde imperiale bonus on home continent
UPDATE ModifierArguments SET Value='5' WHERE ModifierId='GARDE_CONTINENT_COMBAT';
...
INSERT OR IGNORE INTO TraitModifiers (TraitType, ModifierId)
VALUES ('TRAIT_CIVILIZATION_NKISI', 'TRAIT_ARCHAEOLOGIST_PROD_BBG');
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType)
VALUES ('TRAIT_ARCHAEOLOGIST_PROD_BBG', 'MODIFIER_PLAYER_UNITS_ADJUST_UNIT_PRODUCTION');
INSERT OR IGNORE INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('TRAIT_ARCHAEOLOGIST_PROD_BBG', 'UnitType', 'UNIT_ARCHAEOLOGIST'),
	   ('TRAIT_ARCHAEOLOGIST_PROD_BBG', 'Amount', '100');
-- free relic for each gouvernment plaza building
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId)
VALUES ('TRAIT_NKISI_PLAZA_BUILDING_RELIC', 'MODIFIER_PLAYER_GRANT_RELIC', 'REQUIREMENT_PLAZA_BUILDING');
INSERT OR IGNORE INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('TRAIT_NKISI_PLAZA_BUILDING_RELIC', 'Amount', '1');
INSERT OR IGNORE INTO TraitModifiers (TraitType, ModifierId)
VALUES ('TRAIT_CIVILIZATION_NKISI', 'TRAIT_NKISI_PLAZA_BUILDING_RELIC');
INSERT OR IGNORE INTO RequirementSets (RequirementSetId, RequirementSetType)
VALUES ('REQUIREMENT_PLAZA_BUILDING', 'REQUIREMENTSET_TEST_ANY');
INSERT OR IGNORE INTO RequirementSetRequirements (RequirementSetId, RequirementId)
VALUES ('REQUIREMENT_PLAZA_BUILDING', 'PLAYER_HAS_GOV_BUILDING_TALL_REQUIREMENT'),
       ('REQUIREMENT_PLAZA_BUILDING', 'PLAYER_HAS_GOV_BUILDING_WIDE_REQUIREMENT'),
       ('REQUIREMENT_PLAZA_BUILDING', 'PLAYER_HAS_GOV_BUILDING_CONQUEST_REQUIREMENT'),
       ('REQUIREMENT_PLAZA_BUILDING', 'PLAYER_HAS_GOV_BUILDING_FAITH_REQUIREMENT'),
       ('REQUIREMENT_PLAZA_BUILDING', 'PLAYER_HAS_GOV_BUILDING_CITYSTATES_REQUIREMENT'),
       ('REQUIREMENT_PLAZA_BUILDING', 'PLAYER_HAS_GOV_BUILDING_SPIES_REQUIREMENT'),
       ('REQUIREMENT_PLAZA_BUILDING', 'PLAYER_HAS_GOV_BUILDING_CULTURE_REQUIREMENT'),
       ('REQUIREMENT_PLAZA_BUILDING', 'PLAYER_HAS_GOV_BUILDING_SCIENCE_REQUIREMENT'),
       ('REQUIREMENT_PLAZA_BUILDING', 'PLAYER_HAS_GOV_BUILDING_MILITARY_REQUIREMENT');
...
-- Berserker unit now can be purchased with Faith
INSERT OR IGNORE INTO TraitModifiers (TraitType , ModifierId)
