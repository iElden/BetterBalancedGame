...
INSERT INTO Parameters(ParameterId, Name, Description, Domain, DefaultValue, ConfigurationGroup, ConfigurationId, GroupId, SortIndex) VALUES
    ('BETA_BAN_TRADE_TREATY', 'LOC_BBG_FRONT_BETA_BAN_TRADE_TREATY_NAME', 'LOC_BBG_FRONT_BETA_BAN_TRADE_TREATY_DESC', 'bool', '1', 'Game', 'BETA_FEATURE_TERRAIN', 'AdvancedOptions', '20000');
