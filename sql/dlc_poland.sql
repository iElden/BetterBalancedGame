...
-- 29/08/2021: Polish hussar +4 aat ballistic
INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_POLISH_HUSSAR_BALLISTIC_BUFF', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', 'BBG_PLAYER_HAS_BALLISTIC_REQUIREMENTS');
INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
    ('BBG_POLISH_HUSSAR_BALLISTIC_BUFF', 'Amount', 4);
INSERT INTO ModifierStrings(ModifierId, Context, Text) VALUES
    ('BBG_POLISH_HUSSAR_BALLISTIC_BUFF', 'Preview', 'LOC_BBG_POLISH_HUSSAR_BALLISTIC_BUFF');

INSERT INTO Types(Type, Kind) VALUES
    ('BBG_POLISH_HUSSARD_BALLISTIC_ABILITY', 'KIND_ABILITY');
INSERT INTO Tags(Tag, Vocabulary) VALUES
    ('CLASS_POLISH_HUSSAR', 'ABILITY_CLASS');
INSERT INTO TypeTags(Type, Tag) VALUES
    ('UNIT_POLISH_HUSSAR', 'CLASS_POLISH_HUSSAR'),
    ('BBG_POLISH_HUSSARD_BALLISTIC_ABILITY', 'CLASS_POLISH_HUSSAR');
INSERT INTO UnitAbilities(UnitAbilityType , Name, Description, Inactive, Permanent) VALUES
    ('BBG_POLISH_HUSSARD_BALLISTIC_ABILITY', 'LOC_BBG_POLISH_HUSSARD_BALLISTIC_ABILITY', 'LOC_BBG_POLISH_HUSSARD_BALLISTIC_ABILITY_DESC', 0, 1);
INSERT INTO UnitAbilityModifiers(UnitAbilityType, ModifierId) VALUES
    ('BBG_POLISH_HUSSARD_BALLISTIC_ABILITY', 'BBG_POLISH_HUSSAR_BALLISTIC_BUFF');

INSERT OR IGNORE INTO RequirementSets(RequirementSetId , RequirementSetType) VALUES
	('BBG_PLAYER_HAS_BALLISTIC_REQUIREMENTS' , 'REQUIREMENTSET_TEST_ALL');
INSERT OR IGNORE INTO RequirementSetRequirements(RequirementSetId , RequirementId) VALUES
	('BBG_PLAYER_HAS_BALLISTIC_REQUIREMENTS', 'BBG_PLAYER_HAS_BALLISTIC_REQUIREMENT');
INSERT OR IGNORE INTO Requirements(RequirementId , RequirementType) VALUES
	('BBG_PLAYER_HAS_BALLISTIC_REQUIREMENT' , 'REQUIREMENT_PLAYER_HAS_TECHNOLOGY');
INSERT OR IGNORE INTO RequirementArguments(RequirementId , Name, Value) VALUES
	('BBG_PLAYER_HAS_BALLISTIC_REQUIREMENT' , 'TechnologyType', 'TECH_BALLISTICS');
