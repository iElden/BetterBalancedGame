...
-- Setup requirements for gov plaza 
INSERT INTO RequirementSets(RequirementSetId, RequirementSetType) VALUES
	('PLAYER_HAS_GOV_DISTRICT','REQUIREMENTSET_TEST_ALL');
INSERT INTO requirements(RequirementId, RequirementType, ProgressWeight) VALUES
	('PLAYER_HAS_GOV_DISTRICT','REQUIREMENT_PLAYER_HAS_DISTRICT', 1);
INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
	('PLAYER_HAS_GOV_DISTRICT', 'PLAYER_HAS_GOV_DISTRICT');
INSERT INTO RequirementArguments(RequirementId, Name, Type, Value) VALUES
	('PLAYER_HAS_GOV_DISTRICT', 'DistrictType', 'ARGTYPE_IDENTITY', 'DISTRICT_GOVERNMENT');
...
INSERT INTO Modifiers(ModifierId, ModifierType, RunOnce, Permanent, OwnerRequirementSetId) VALUES
    ...
    ('BBG_KONGO_RELIC_GOVBUILDING_MILITARY', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_DISTRICT');

INSERT INTO Modifiers(ModifierId, ModifierType, RunOnce, NewOnly, Permanent, Repeatable, OwnerRequirementSetId) VALUES
    ('BBG_KONGO_RELIC_GOV_PLAZA_DISTRICT', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 0, 1, 0, 'CITY_HAS_GOV_DISTRICT');
...
INSERT INTO ModifierArguments(ModifierId, Name, Type, Value) VALUES
    ('BBG_KONGO_RELIC_GOV_PLAZA_DISTRICT', 'Amount', 'ARGTYPE_IDENTITY', '1');
...
INSERT INTO TraitModifiers(TraitType, ModifierId) VALUES
    ...
    ('TRAIT_CIVILIZATION_NKISI', 'BBG_KONGO_RELIC_GOV_PLAZA_DISTRICT');
