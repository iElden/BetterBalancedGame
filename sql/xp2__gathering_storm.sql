...
INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId)
    SELECT 'BBG_ELEONORE_' || GreatWorkObjectTypes.GreatWorkObjectType || '_' || DistrictType || '_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_GREATWORK_YIELD', 'BBG_CITY_HAS_' || DistrictType
    FROM TmpEldenEleonore CROSS JOIN GreatWorkObjectTypes;
