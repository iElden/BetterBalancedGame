...
INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId) VALUES
  ('BBG_TEDDY_COMBAT_BONUS_IN_ERA_ANCIENT', 'MODIFIER_PLAYER_UNITS_ADJUST_COMBAT_STRENGTH', 'BBG_TEDDY_IS_IN_ANCIENT'),
  ('BBG_TEDDY_COMBAT_BONUS_IN_ERA_CLASSICAL', 'MODIFIER_PLAYER_UNITS_ADJUST_COMBAT_STRENGTH', 'BBG_TEDDY_IS_IN_CLASSICAL'),
  ('BBG_TEDDY_COMBAT_BONUS_IN_ERA_MEDIEVAL', 'MODIFIER_PLAYER_UNITS_ADJUST_COMBAT_STRENGTH', 'BBG_TEDDY_IS_IN_MEDIEVAL'),
  ('BBG_TEDDY_COMBAT_BONUS_IN_ERA_RENAISSANCE', 'MODIFIER_PLAYER_UNITS_ADJUST_COMBAT_STRENGTH', 'BBG_TEDDY_IS_IN_RENAISSANCE'),
  ('BBG_TEDDY_COMBAT_BONUS_IN_ERA_INDUSTRIAL', 'MODIFIER_PLAYER_UNITS_ADJUST_COMBAT_STRENGTH', 'BBG_PLAYER_IS_IN_ERA_INDUSTRIAL_REQUIREMENTS');
...
INSERT INTO ModifierStrings (ModifierId, Context, Text) VALUES
 ...
 INSERT INTO TraitModifiers(TraitType, ModifierId)
    SELECT 'TRAIT_LEADER_ROOSEVELT_COROLLARY', 'BBG_TEDDY_COMBAT_BONUS_IN_' || EraType
    FROM Eras
