...
INSERT INTO Types(Type, Kind) VALUES
    ...
    ('BBG_IGNORE_HILLS_ABILITY', 'KIND_ABILITY');
...
INSERT INTO TypeTags(Type, Tag) VALUES
    ...
    ('BBG_IGNORE_HILLS_ABILITY', 'CLASS_NAGAO');
...
INSERT INTO UnitAbilities(UnitAbilityType, Name, Description, Inactive, ShowFloatTextWhenEarned, Permanent)  VALUES
    ...
    ('BBG_IGNORE_HILLS_ABILITY', 'LOC_BBG_IGNORE_HILLS_ABILITY_NAME', 'LOC_BBG_IGNORE_HILLS_ABILITY_DESCRIPTION', 0, 0, 1);
...
--Fixed base-game bug: Kongo not getting all religious bonuses
--isue: https://github.com/iElden/BetterBalancedGame/issues/161
--Fix by FlashyFeeds, testing by ZhenjaMax
INSERT INTO Requirements(RequirementId, RequirementType) VALUES
	('REQUIRES_PLAYER_IS_RELIGIOUS_CONVERT_PFBF', 'REQUIREMENT_PLAYER_HAS_CIVILIZATION_OR_LEADER_TRAIT');

INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
	('REQUIRES_PLAYER_IS_RELIGIOUS_CONVERT_PFBF', 'TraitType', 'TRAIT_LEADER_RELIGIOUS_CONVERT');

INSERT INTO RequirementSets(RequirementSetId, RequirementSetType) VALUES
	('PLAYER_IS_CONVERTED_RELIGIOUS_CONVERT_REQUIREMENTSET_PFBF', 'REQUIREMENTSET_TEST_ALL');

INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
	('PLAYER_IS_CONVERTED_RELIGIOUS_CONVERT_REQUIREMENTSET_PFBF', 'REQUIRES_PLAYER_IS_RELIGIOUS_CONVERT_PFBF'),
	('PLAYER_IS_CONVERTED_RELIGIOUS_CONVERT_REQUIREMENTSET_PFBF', 'REQUIRES_SAME_RELIGION');

INSERT INTO Requirements(RequirementId, RequirementType) VALUES
	('REQUIRES_PLAYER_IS_CONVERTED_RELIGIOUS_CONVERT_PFBF', 'REQUIREMENT_REQUIREMENTSET_IS_MET');

INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
	('REQUIRES_PLAYER_IS_CONVERTED_RELIGIOUS_CONVERT_PFBF', 'RequirementSetId', 'PLAYER_IS_CONVERTED_RELIGIOUS_CONVERT_REQUIREMENTSET_PFBF');

UPDATE RequirementSets Set RequirementSetType='REQUIREMENTSET_TEST_ANY' WHERE RequirementSetId='PLAYER_FOUNDED_RELIGION_REQUIREMENTS';

INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
	('PLAYER_FOUNDED_RELIGION_REQUIREMENTS', 'REQUIRES_PLAYER_IS_CONVERTED_RELIGIOUS_CONVERT_PFBF');
